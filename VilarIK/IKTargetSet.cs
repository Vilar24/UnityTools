...
namespace VilarIK {
	...
	public class IKTargetSet {
		...
		public IKTargetSet(Animator animator) {
			...
			targets[(int)parts.HANDLEFT] = CreateMatrixFromLocalTransform(animator.GetBoneTransform(HumanBodyBones.LeftHand), localRoot, Quaternion.Euler(45f, -90f, 0f));
			targets[(int)parts.HANDRIGHT] = CreateMatrixFromLocalTransform(animator.GetBoneTransform(HumanBodyBones.RightHand), localRoot, Quaternion.Euler(45f, 90f, 0f));
			...
			targets[(int)parts.ELBOWLEFT] = CreateMatrixFromLocalTransform(animator.GetBoneTransform(HumanBodyBones.LeftLowerArm), localRoot, Quaternion.Euler(45f, -90f, 0f));
			targets[(int)parts.ELBOWRIGHT] = CreateMatrixFromLocalTransform(animator.GetBoneTransform(HumanBodyBones.RightLowerArm), localRoot, Quaternion.Euler(45f, 90f, 0f));
